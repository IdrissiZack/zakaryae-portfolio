                ...
                <div className="hero-content">
                    ...
                    <div className="hero-image-container fade-in">
                        <div className="hero-image-wrapper">
                            <img
                                src={mainimg}
                                alt="Zakaryae - Cybersecurity Engineering Student"
                        ...
                        <div className="hero-socials">
                            ...
                            <a href="https://www.linkedin.com/in/zakaryae-janati-idrissi-43b968381/" target="_blank" rel="noopener noreferrer" className="social-link">
    <i className='bx bxl-linkedin-square'></i>
                    ...
                    <div className="hero-text">
                        <h1 className="hero-title slide-in-right">
                          Hi, I'm <span className="gradient-text">Zakaryae</span>
                        </h1>
                        ...
                        <p className="hero-description slide-in-right" style={{ animationDelay: '0.4s' }}>
                            Software Engineering student focused on Cybersecurity, Web Security, and Penetration Testing.
                        </p>
