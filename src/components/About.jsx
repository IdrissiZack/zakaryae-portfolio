    ...
    useEffect(() => {
        const fetchGitHubData = async () => {
            ...
            try {
                ...
                const profileRes = await fetch('https://api.github.com/users/IdrissiZack', {
                ...
                const statusRes = await fetch('https://github-contributions-api.jogruber.de/v4/IdrissiZack');
                if (!statusRes.ok) throw new Error('Stats fetch failed');
                const stats = await statusRes.json();

                // 3. Fetch Repositories for Languages
                const reposRes = await fetch('https://api.github.com/users/IdrissiZack/repos?sort=updated&per_page=100', {
                    headers: { 'Accept': 'application/vnd.github.v3+json' }
                });
            ...
            <div className="container">
                ...
                <div className="github-impact reveal">
                    <div className="section-header center">
                        ...
                        <p className="section-subtitle">A growing technical profile built through software engineering, cybersecurity labs, and practical security learning.</p>
                    </div>
                    ...
                    <div className="github-lux-container glass-card">
                            ...
                            <div className="github-profile-brief">
                                <div className="profile-icon-wrapper">
                                    {githubData.avatarUrl ? (
                                        <img src={githubData.avatarUrl} alt="IdrissiZack" className="profile-avatar" />
                                    ) : (
                                ...
                                <div className="profile-text">
                                    <h4>IdrissiZack</h4>
                                    <p className="profile-meta">Cybersecurity Student</p>
                                </div>
                            </div>
                        ...
                        <div className="github-languages-section">
                            <div className="lang-header">
                                <span className="lang-title">Tech Security & Development Stack</span>
                        ...
                        <div className="github-lux-grid dual-col">
                            <div className="lux-stat-item">
                                <span className="lux-label">Technical Focus</span>
                                <span className="lux-value">
                                    <AnimatedNumber value={githubData.contributions} suffix="+" />
                                </span>
                            </div>
                            <div className="lux-stat-item">
                                <span className="lux-label">Learning Since </span>
                        ...
                        <div className="github-lux-graph">
                            ...
                            <div className="graph-scroll-container">
                                <img
                                    src="https://ghchart.rshah.org/3cf82f6/IdrissiZack"
                        ...
                        <div className="github-activity-footer">
                            <div className="last-pulse-card">
                                <div className="pulse-indicator">
                                    ...
                                    <span className="pulse-label">Current Focus</span>
                                </div>
                            ...
                            <div className="github-action-grid">
                                <a href="https://github.com/IdrissiZack" target="_blank" rel="noopener noreferrer" className="gh-action-btn star-btn">
                                    <i className='bx bx-star'></i> Star Portfolio
                                </a>
                                <a href="https://github.com/IdrissiZack" target="_blank" rel="noopener noreferrer" className="gh-action-btn follow-btn">
                ...
                <div className="bento-grid-v2">
                    ...
                    <div className="bento-card-v2 bio-card-v2 reveal">
                        ...
                        <div className="card-content">
                           <h3>Cybersecurity & Software Engineering</h3>
                            <p>
                              I'm Zakaryae, a Software Engineering student focused on Cybersecurity, Web Security, and Penetration Testing. I'm developing my skills through hands-on security labs, technical projects, and continuous learning.
                            </p>
                        </div>
                    </div>

                    {/* <span>Cybersecurity Profile</span> Card - Tall & Visual */}
                    <div className="bento-card-v2 profile-card-v2 reveal">
                        <div className="image-wrapper">
                            <img src={main} alt="Zakaryae Idrissi" />
                            <div className="profile-overlay">
                                <h4>Zakaryae Idrissi</h4>
                    ...
                    <div className="bento-card-v2 impact-card-v2 reveal">
                        ...
                        <div className="impact-stats-v2">
                            <div className="stat-group">
                                ...
                                <span className="stat-lab">Projects in Progress</span>
                            </div>
                            <div className="stat-group">
                                <span className="stat-val">
                                   <AnimatedNumber value={0} suffix="%" />
                                </span>
                                <span className="stat-lab">Security Labs</span>
                            </div>
                        </div>
                    </div>
